...
<script>
        ...
        function redirectToPlay() {
            window.location.href = "/Yu-Gi-Oh-Simulator/Includes/Rules.php";
        }
...
<button onclick="redirectToPlay()" class="play">Rules to Play</button>
...
<h2>Create Decks and export them with our website!</h2><br>
...
<h2>If you want more information about the cards or the rules please</h2>
